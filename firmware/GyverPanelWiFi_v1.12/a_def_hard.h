...
#define A_DEF_DEVC 0          // 1 - Настройки профилей ваших устройств в отдельном файле a_def_devc.h
...
#define WIDTH 20                // ширина одного сегмента матрицы
#define HEIGHT 10               // высота одного сегмента матрицы
