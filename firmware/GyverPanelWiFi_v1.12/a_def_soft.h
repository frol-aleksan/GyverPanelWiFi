...
#define EFFECT_LIST F("Часы,Свет,Снег,Куб,Радуга,Пейнтбол,Огонь,Matrix,Шарики,Метеоры,Конфетти,Переливы," \
                      ...
                      "Maze,Snake,Tetris,Теннис,Flappy,Runner,Одеяло,Спектр,Синус,Узор,Дождь,Камин," \
                      ...
                      "Дым,Пульс,Вода,Вихри,Стая,Змей,Паук,Фонтан,Аврора,Часы2,Салют,Трек,Краски,Свеча,"\
                      "Рубик,Кудри,Лотос,Елка,Песок,Лента,Star,Лампа,Замок,Серпантин,Tixy,Spin,"\
                      "Утро,SD")
#else
#define EFFECT_LIST F("Часы,Свет,Снег,Куб,Радуга,Пейнтбол,Огонь,Matrix,Шарики,Метеоры,Конфетти,Переливы," \
                      "Дизайн,Контакт,Звезды,Штора,Цвета,Светляки,Палитра,Циклон,Хаос,Сияние,Тени," \
                      ...
                      "Cube,Quantum,Фeя,Kaпли,Ocциллятop,Kипeниe,Дpaжe,Boлны,Круг,Пикacco,Люмeньep,Шapы,Море,"\
                      "Дым,Пульс,Вода,Вихри,Стая,Змей,Паук,Фонтан,Аврора,Часы2,Салют,Трек,Краски,Свеча,"\
                      "Рубик,Кудри,Лотос,Елка,Песок,Лента,Star,Лампа,Замок,Серпантин,Tixy,Spin,Утро")
#endif
#else
#if (USE_SD == 1)                      
#define EFFECT_LIST F("Часы,Свет,Снег,Куб,Радуга,Пейнтбол,Огонь,Matrix,Шарики,Метеоры,Конфетти,Переливы," \
...
#endif
#else
#define MC_IMAGE                87         // Анимция
#define MC_DAWN_ALARM           88         // Рассвет
#define MC_SDCARD               89         // SD-карта

#if (USE_SD == 1)
#define MAX_EFFECT              90         // количество эффектов, определенных в прошивке
#else
#define MAX_EFFECT              89         // количество эффектов, определенных в прошивке
#endif
#endif
