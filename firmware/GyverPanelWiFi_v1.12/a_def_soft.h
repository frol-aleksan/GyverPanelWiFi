...
#define EFFECT_LIST F("Часы,Свет,Снег,Кубик,Радуга,Пейнтбол,Огонь,Matrix,Шарики,Звездопад,Конфетти,Цветной шум," \
                      ...
                      "Бacceйн,Дым,Пульс,Водопад,Вихри,Кометы,Змей,Плазмолампа,Источник,Аврора,"\
                      "Рассвет,SD-Карта")
#else
#define EFFECT_LIST F("Часы,Свет,Снег,Кубик,Радуга,Пейнтбол,Огонь,Matrix,Шарики,Звездопад,Конфетти,Цветной шум," \
                      "Облака,Лава,Плазма,Переливы,Павлин,Зебра,Лес,Прибой,Цвета,Светлячки,Водоворот,Циклон,Мерцание," \
...
// Часы в фоторамке - размер 17x11 - для них нет картинки анимации - эффект анимация удален из прошивки
#ifdef NO_ANIMATION
#define MC_DAWN_ALARM           74         // Рассвет         
#define MC_SDCARD               75         // SD-карта

#if (USE_SD == 1)
#define MAX_EFFECT              76         // количество эффектов, определенных в прошивке
#else
#define MAX_EFFECT              75         // количество эффектов, определенных в прошивке
#endif
#else
#define MC_IMAGE                74         // Анимция
#define MC_DAWN_ALARM           75         // Рассвет
#define MC_SDCARD               76         // SD-карта

#if (USE_SD == 1)
#define MAX_EFFECT              77         // количество эффектов, определенных в прошивке
#else
#define MAX_EFFECT              76         // количество эффектов, определенных в прошивке
#endif
#endif
