...
// проект не будет компилироваться
//
//Доработка от меня: добавлены игры Flappy Bird и Runner из первой версии проекта Gyver BT Matrix с частичной
//адаптацией под текущий проект (изменены параметры по умолчанию, исправлен вывод количества очков и т. п.)
//Исправлены коды эффектов в a_def_soft.h из-за чего штатно последовательный перебор эффектов работает неправильно
//Конфигурация сделана в первую очередь под меня лично - матрица 20*10, нода без дополнительных компонентов
//
// -------------------------------------------------------------------------------------------------------
