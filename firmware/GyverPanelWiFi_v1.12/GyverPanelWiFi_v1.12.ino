...
//Добавил эффект "Плазмолампа". Вычистил закомментированный мусор. Попытался сделать последовательное воспроизведение всех вариантов волн, но что-то пошло не так.
