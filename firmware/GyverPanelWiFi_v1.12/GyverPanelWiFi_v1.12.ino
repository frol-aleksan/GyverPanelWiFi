...
//Добавил тонну эффектов из прошивки gunner47_v2, теперь их стало просто д...я, а именно 74, если подключить SD-карту, или 73 без нее.
//Список вырос на 27 позиций, объединил имеющийся эффект PRIZMATA с аналогичным из gunner47. Теперь их два в списке Вариант в параметрах эффекта Синусы.
