...
//Объединил имеющийся эффект PRIZMATA (Синусы) с одноименным эффектом из прошивки gunner47. Теперь их два в списке Вариант в параметрах эффекта Синусы.
...
//Посему настройка параметров матрицы в приложении PanelSetup приводила к неверному отображению эффектов. После замены HEIGHT и WIDTH на pHEIGHT и pWIDTH все должно работать правильно.
...
//и иницализировать его в функции setup(), т. к. в файле effects.h возможно объявлять только статические массивы с константами. Поправил нахождение середины в эффекте Драже.
//
...
#define FIRMWARE_VER F("WiFiPanel v.1.12.2022.10.04") //переходим на обозначение версий по дате
