...
//Добавил в качестве второго варианта к эффекту Nexus змеек, тем более, что эти два эффекта во многом похожи. Также добавил эффект "Аврора". Странно, что не сделал это раньше.
...
//Пока доработку прошивки можно считать финальной.
//Итого имеем 82/81 эффекта с/без SD.
...
#define FIRMWARE_VER F("WiFiPanel v.1.12.2022.11.28") //переходим на обозначение версий по дате
