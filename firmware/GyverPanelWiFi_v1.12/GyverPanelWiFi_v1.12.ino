...
//Убран ползунок варианта из добавленных эффектов, где он не нужен. Добавлен ползунок варианта на изменение количества червячков в пределах 1..2*pWIDTH в эффекте NEXUS.
...
//Произведены некоторые мелкие доработки. Включен ползунок скорости у камина, поскольку эффект работал слишком быстро. Отключены ненужные ползунки.
...
//Итого в деморежиме доступно 87/86 эффектов с/без SD. Со всеми вариантами имеем свыше 160 эффектов, если не считать анимации для эффекта SD.
// -------------------------------------------------------------------------------------------------------
