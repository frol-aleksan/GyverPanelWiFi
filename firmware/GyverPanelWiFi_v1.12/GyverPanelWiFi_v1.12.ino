...
// Добавлены и адаптированы эффекты из прошивок от AlexGyver, gunner47, Shaitan и alvikskor
// https://AlexGyver.ru/
//
...
//Добавлены эффекты из прошивки gunner47_v2. Имеющийся эффект PRIZMATA (Синусы) объединен с одноименным эффектом из прошивки gunner47;
...
//К эффекту Nexus вторым вариантом добавлен эффект Змейки, тем более, что эти два эффекта визуально похожи между собой; 
...
//Переделано пламя свечи. Для низких матриц оно было странное, теперь больше напоминает настоящее;
...
//Добавлены эффект Tixy Land (26 вариантов, случайный выбор, автоперебор;
//Добавлен эффект Серпантин с алгоритмом выбора направления эффекта (по аналогии с эффектами Prizmata и ДНК);
...
//Вычищен ничего не делающий мусор в эффектах: Капли, Осциллятор;
...
//Спирали - добавлена сегментация;
//Свеча - вычищен ничего не делающий мусор, добавлен сдвиг свечи, добавлен выбор цвета пламени (вдруг нравится зеленый?) на ползунок контраста, добавлена сегментация;
//Песок - перепахан код эффекта, добавлена сегментация;
//Драже - перепахан код эффекта, добавлена сегментация
//Добавлены макросы на вывод времени рассвета и заката в текущий день. ХЗ зачем, но пусть будут.

//TODO:
//В перспективе добавить сегментацию на ряд эффектов - в процессе (самое главное - сделаны Свеча, Спирали, Песок, Драже)
...
#define FIRMWARE_VER F("WiFiPanel v.1.12.2026.01.04") //переходим на обозначение версий по дате
...
void setup() {
  ...
  //Трехмерный динамический массив, необходимый для работы ряда эффектов из сторонних прошивок
