...
void fountainsRoutine(){
  if (loadingFlag)
  {
    ...
    for(int j = 0; j<enlargedObjectNUM; j++){
      ...
      //boids[j].location.x = random8(pWIDTH);
      //boids[j].location.y = random8(pHEIGHT);
