...
- Гирлянда: https://aliexpress.ru/item/1005003294515692.html<br>
Раньше было едва ли не самое дешевое предложение на Алиэкспрессе, особенно если брать сразу по 10 гирлянд, но сейчас есть варианты и подешевле. Стоит иметь ввиду, что закупать гирлянды лучше сразу на весь проект, потому что от партии к партии яркость/цветовая температура светодиодных модулей может отличаться. За все время с 2020 по 2022 год заказывал у этого продавца 23 гирлянды, из них оказался всего один полностью поврежденный светодиодный модуль (не зажигался и не передавал данные дальше) и еще два под вопросом (сигнал принимают, зажигаются, но дальше по цепочке не передают; может они были такие изначально, а может повредились при эксплуатации - сложно сказать).<br>
Еще несколько недорогих вариантов:<br>
  https://aliexpress.ru/item/1005004647471625.html<br>
  https://aliexpress.ru/item/4000547380572.html<br>
  https://aliexpress.ru/item/1005003252674988.html<br>
  https://aliexpress.ru/item/1005002309608620.html<br>
  https://aliexpress.ru/item/1005003286423415.html<br>
Как альтернативный ультрабюджетный вариант можно предложить готовые 10- и 20-метровые умные гирлянды, управляемые с пульта и через Bluetooth. Парадоксально, но на Озоне они стоят в разы дешевле, чем у китайцев на Али. Встроенные эффекты в заводских контроллерах однотипные, но для самодельщика главное - сама гирлянда. От ESP зажигается, как и обычная WS2812. Cтоит иметь ввиду, что очередность вывода цветов в разных гирляндах может быть абсолютно разная (так, мне попадались варианты с порядком цветов RGB и BGR), поэтому нужно заазывать одинаковые гирлянды. При дозаказе недостающих гирлянд можно ориентироваться по внешнему виду пульта. Основное неудобство работы с такими гирляндами - их придется резать на секции, соответственно, надо брать их с некоторым запасом, чтобы не собирать нитку из обрезков. После сборки матрицы, в свою очередь, могут остаться неликвидные обрезки гирлянды (например, у меня при изготовлении матрицы 14*13 из двух гирлянд по 100 модулей оставалось два обрезка по 9 модулей).
- Матрица 16*16 с контроллером: https://aliexpress.ru/item/1005003698849342.html<br>
Матрицу использую для отладки прошивки, к контроллеру подключаю куски гирлянды, оставшиеся после сборки матриц. Просто матрицу можно найти дешевле, но вместе с контроллером это предложение остается более выгодным.
...
Нужны, если хотите сделать сборно-разборную и легко масштабируемую в ширину матрицу.
- Блок питания на 5В: https://aliexpress.ru/item/32969395947.html
- Гнездо питания на провод: https://aliexpress.ru/item/4000498662374.html<br>
Нужно именно 5.5/2.5! Не перепутайте!
- Плата ESP 8266: https://aliexpress.ru/item/1005001636634198.html (NodeMCU)<br>
  https://aliexpress.ru/item/1005009623933946.html (WeMos)
...
Если матрица "шумит" (поверх выводимого эффекта прозвольно вспыхивают светодиоды) или хаотически мигают первые 10-20 светодиодов, укоротите провод от микроконтроллера к угловой точке подключения хотя бы до 3 метров.
...
Добавлены список регионов для получения погоды от Яндекса и инструкция по использованию матрицы в формате DOCX. Документ сверстан так, чтобы его можно было распечатать и сшить в брошюру формата A5 (A4, сложенный пополам). Для печати брошюры в настройках принтера или в диалоге печати офисного пакета выберите печать на обеих сторонах. Печатать лучше всего из Microsoft Office 2010. В других офисных пакетах верное отображение и печать документа не гарантируется (в Libre и Open Office "едет" гарантированно).
